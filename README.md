...
The code runs on a Ubuntu 18.04 computer installed with ROS Melodic. Install dependencies,

```sudo apt update```

```sudo apt install libusb-dev```

Clone the repository and checkout the 'melodic' branch. In a terminal, go to the folder, compile, and source the ROS workspace,
